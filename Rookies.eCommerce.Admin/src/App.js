          ...
          <div className="col-3 d-flex flex-column flex-shrink-0 justify-content-between p-3 bg-light">
            <div className='sidebar-main'>
              ...
              <ul className='nav nav-pills flex-column mb-auto' >
                <li>
                  <button class="btn btn-toggle fs-5 d-inline-flex align-items-center rounded border-0 collapsed mb-2" data-bs-toggle="collapse" data-bs-target="#home-collapse" aria-expanded="false">
                  ...
                  <div class="collapse show" id="home-collapse">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                      ...
                      <li className='ms-4'>
                        <NavLink className='nav-link fs-6 d-flex align-items-center' exact to="/UpdatingHome">
                          <span className='d-flex align-items-center justify-content-center me-2'>
                ...
                {/* quan ly nguoi dung */}
                <li>
                  <button class="btn btn-toggle fs-5 d-inline-flex align-items-center rounded border-0 collapsed mb-2" data-bs-toggle="collapse" data-bs-target="#user-collapse" aria-expanded="false">
                    <span className='d-flex align-items-center justify-content-center me-2'>
                ...
                {/* quan ly san pham */}
                <li>
                  <button class="btn btn-toggle fs-5 d-inline-flex align-items-center rounded border-0 collapsed mb-2" data-bs-toggle="collapse" data-bs-target="#product-collapse" aria-expanded="false">
                    <span className='d-flex align-items-center justify-content-center me-2'>
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-inboxes" viewBox="0 0 16 16">
                ...
                {/* quan ly danh muc */}
                <li>
                  <button class="btn btn-toggle fs-5 d-inline-flex align-items-center rounded border-0 collapsed mb-2" data-bs-toggle="collapse" data-bs-target="#category-collapse" aria-expanded="false">
                    <span className='d-flex align-items-center justify-content-center me-2'>
                ...
                {/* quan ly thuong hieu */}
                <li>
                  <button class="btn btn-toggle fs-5 d-inline-flex align-items-center rounded border-0 collapsed mb-2" data-bs-toggle="collapse" data-bs-target="#brand-collapse" aria-expanded="false">
                    <span className='d-flex align-items-center justify-content-center me-2'>
